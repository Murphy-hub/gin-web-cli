...
import (
	...
	"github.com/Murphy-hub/gin-web-cli/internal/actions"
...
func New() *cli.Command {
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				Name:  "git-url",
				Usage: "Use git repository to initialize the project (default: https://github.com/Murphy-hub/gin-admin.git)",
				Value: "https://github.com/Murphy-hub/gin-admin.git",
			},
			&cli.StringFlag{
				Name:  "git-branch",
